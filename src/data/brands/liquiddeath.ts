...
export const founderData = {
  ...
  title: "Founder",
  education:
    "Bachelor Degree: Communication and Rhetoric from the University of Pittsburgh.",
  professionalBackground: [
    "Served as Creative Director at various advertising agencies, developing campaigns for high-profile brands.",
    "Produced the 'Save the Bros' campaign for Organic Valley.",
  ...
  entrepreneurialCareer: {
    title: "Founder and CEO of Liquid Death",
    ventures: {
      preLiquidDeath: "Explored creating a brandy brand called Western Grace.",
      liquidDeathLaunch:
        "Founded in 2017 with three partners: J.R. Riggins, Pat Cook (a bartender), and Will Carsola (an artist).",
    },
  },
  inspiration: [
    "Inspired by punk rock culture and the Vans Warped Tour music festival.",
    "Background in graphic design and advertising.",
    "Influenced by Mad Magazine and the DIY ethos of punk culture.",
  ],
  publicPresence: [
    "Active on social media platforms.",
    "Featured in interviews and articles in various publications.",
    "Speaks at events about entrepreneurship and branding.",
  ],
};
...
export const distributionStages = [
  {
    year: "2019",
    stage: "Pure DTC Launch",
    requirements: [
      "Initial seed funding of £1.79M secured",
      "E-commerce infrastructure established",
      "Direct digital marketing capabilities",
      "Subscription model framework",
      "Basic fulfillment operations",
    ],
    keyMetrics: [
      "Revenue: £2.35M",
  ...
  {
    year: "2020",
    stage: "Initial Retail Expansion",
    requirements: [
      "Series A funding (£7.68M)",
      "Proven DTC model success",
    ...
    keyMetrics: [
      "Retail placement success rate",
      "Store-level performance",
      "Supply chain efficiency",
      "Retail margin structure",
    ],
    enablers: [
      "Whole Foods partnership secured",
      "7-Eleven pilot success",
  ...
  {
    year: "2021",
    stage: "Event & Venue Expansion",
    requirements: [
      "Series B1 funding (£7.18M)",
      "Proven retail success",
      "Event-specific logistics",
      "Live Nation partnership",
      "Venue-specific packaging",
      "Large-scale distribution",
    ],
    keyMetrics: [
      "Revenue: £32.7M",
      "Venue sales performance",
  ...
  {
    year: "2022",
    stage: "Mass Market Retail",
    requirements: [
      "Series C & D funding (£118.25M)",
...
export const marketingStages = [
  {
    ...
    requirements: [
      ...
      "Clear ROI measurement system",
      "Content production capability",
    ],
    examples: [
      {
        partnership: "Tony Hawk Collaboration",
        conditions: [
          "Series B1 funding secured",
          "Strong alternative sports presence",
          "Creative campaign capability",
          "Product innovation pipeline",
        ],
      },
      {
        partnership: "Wiz Khalifa Partnership",
        conditions: [
          "Cultural relevance established",
  ...
  },
  {
    ...
    requirements: [
      ...
      "Distribution network maturity",
    ],
    examples: [
      {
        partnership: "Burton Collaboration",
        conditions: [
          "Lifestyle brand positioning",
          "Winter sports market presence",
          "Premium product capability",
          "Retail distribution network",
        ],
      },
      {
        partnership: "Van Leeuwen Partnership",
        conditions: [
          "Innovation capability",
          "Premium positioning",
          "Product development process",
          "Market testing infrastructure",
        ],
      },
    ],
  },
  {
    ...
    examples: [
      {
        partnership: "Fortnite Integration",
        conditions: [
          "Digital brand strength",
          "Gaming demographic alignment",
          "Technical partnership capability",
          "Digital content strategy",
        ],
      },
      {
        partnership: "Live Events",
        conditions: [
          "Event logistics capability",
          "Venue partnerships",
          "Large-scale distribution",
...
export const valuationData = [
  ...
  {
    date: "2021-05-15",
    preMoneyValuation: 110.59,
    postMoneyValuation: 117.77,
  },
  {
    date: "2022-01-03",
    preMoneyValuation: 367.01,
    postMoneyValuation: 423.3,
  },
  {
    date: "2022-10-03",
    preMoneyValuation: 588.6,
    postMoneyValuation: 650.56,
  },
  {
    date: "2023-05-11",
    preMoneyValuation: 843.56,
    postMoneyValuation: 904.79,
  },
  {
    date: "2024-03-11",
    preMoneyValuation: 1050.0,
    postMoneyValuation: 1100.0,
  },
];
...
export const revenueWithMilestones = [
  { year: 2019, revenue: 2.351, milestone: "DTC Focus" },
  { year: 2020, revenue: null, milestone: "Retail Expansion" },
  { year: 2021, revenue: 32.724, milestone: "Celebrity Partnerships" },
  { year: 2022, revenue: 105.479, milestone: "Product Diversification" },
  { year: 2023, revenue: 209.165, milestone: "International Entry" },
];
...
export const businessEvents = [
  {
    ...
    event: "D2C Launch & Subscription Model",
  },
  { year: 2020, category: "Retail", event: "Whole Foods & 7-Eleven Entry" },
  { year: 2021, category: "Marketing", event: "Tony Hawk Blood Skateboard" },
  {
    year: 2021,
    category: "Partnership",
    event: "Live Nation Exclusive Deal",
  },
  { year: 2022, category: "Product", event: "Flavored Water Launch" },
  { year: 2023, category: "Expansion", event: "International Markets Entry" },
  {
    year: 2024,
    category: "Innovation",
    event: "Gaming & Digital Partnerships",
  },
];
...
export const HEADINGS = {
  line1: "TURNING WATER INTO A BOLD",
  line2: "LIFESTYLE STATEMENT",
  mainHeading: "LIQUID.DEATH",
  imageAlt: "Liquid Death Canned Water Products",
};

...
export const HEADINGS = {
  line1: "REVOLUTIONIZING HEALTHY",
  line2: "HYDRATION WITH ZERO SUGAR",
  mainHeading: "LEMON.PERFECT",
  imageAlt: "Lemon Perfect Enhanced Water Products",
};
...
export const timelineData = [
  ...
  {
    date: "2021",
    eventName: "Early Stage VC (Series A)",
    category: "Funding",
    eventDescription: "Received Series A funding of $27.16 million.",
    additionalInfo: {
      investors: [
        "Skyview Capital",
        "RCV Frontline",
      ...
      purpose: "Scale operations, expand retail footprint, and marketing.",
      preMoneyValuation: "$30 million",
      postMoneyValuation: "$42.44 million",
    },
  },
  {
    date: "2022",
    eventName: "Series A Additional Funding",
    category: "Funding",
    eventDescription: "Received an additional $31 million in Series A funding.",
    additionalInfo: {
      investors: ["Beyoncé", "Sloane Stephens", "Jalen Hurts"],
      purpose: "Expand reach in U.S. markets, increase brand visibility.",
      projectedRevenue: "$60 million",
    },
  },
  {
    date: "2023",
    ...
    category: "Funding",
    eventDescription: "Secured $36.79 million in Series B funding.",
    additionalInfo: {
      investors: [
        "93 Ventures",
      ...
      purpose:
        "Accelerate growth, expand to more retail stores, and marketing.",
      preMoneyValuation: "$106 million",
      postMoneyValuation: "$116.46 million",
    },
  },
  ...
  {
    date: "2019",
    eventName: "Digital Marketing Launch",
    category: "Branding & Marketing",
    eventDescription:
      "Launched digital marketing campaigns focused on zero-sugar, all-natural ingredients.",
    additionalInfo: {
      targetAudience: "Health-conscious millennials",
      initialChannels: ["Social Media", "E-commerce platform"],
    },
  },
  {
    date: "2022",
    eventName: "Celebrity Endorsements",
    category: "Branding & Marketing",
    eventDescription:
      "Beyoncé joined as an investor, significantly boosting brand visibility.",
    additionalInfo: {
      additionalCelebrities: ["Jalen Hurts", "Sloane Stephens"],
      marketingImpact:
        "Increased brand reach and appeal in the fitness community.",
    },
  },
  {
    date: "2023",
    eventName: "Nationwide Sampling Campaign",
    category: "Branding & Marketing",
    eventDescription:
      "Launched 'Stay Hydrated, Stay Perfect' and 'Drink More Lemons' campaigns.",
    additionalInfo: {
      strategies: ["Mobile sampling", "Celebrity Ambassadors"],
      outcome:
        "Enhanced nationwide visibility and engagement with Gen Z consumers.",
    },
  },
  ...
  {
    date: "2019",
    eventName: "Launch Pricing Strategy",
    category: "Pricing",
    eventDescription:
      "Priced at $1.99 for 12 oz., reflecting premium positioning with organic ingredients.",
    additionalInfo: {
      discounts: "Frequent BOGO offers to incentivize trial.",
      goal: "Establish premium brand while building loyalty.",
    },
  },
  {
    date: "2023",
    eventName: "Transitioned to 15.2 oz Bottles",
    category: "Pricing",
    eventDescription:
      "Increased bottle size to 15.2 oz., adjusting price to approximately $2.29.",
    additionalInfo: {
      pricingStrategy:
        "Offer more value per bottle to compete in the hydration market.",
    },
  },
  ...
  {
    date: "2017",
    eventName: "Launch of Lemon Perfect",
    category: "Product",
    eventDescription:
      "Founded with a focus on zero-sugar, all-natural lemon-flavored water.",
    additionalInfo: {
      initialFlavor: "Lemon",
      productFeatures: "Cold-pressed, organic, 5 calories per serving.",
    },
  },
  {
    date: "2021",
    eventName: "Expanded Flavors",
    category: "Product",
    eventDescription:
      "Introduced Dragon Fruit Mango, Strawberry Passionfruit, and Peach Raspberry flavors.",
    additionalInfo: {
      purpose: "Attract broader consumer base with diverse taste preferences.",
    },
  },
  {
    date: "2023",
    eventName: "Further Flavor Expansion",
    category: "Product",
    eventDescription:
      "Added Blueberry, Coconut, and Watermelon flavors, enhancing variety.",
    additionalInfo: {
      currentFlavorCount: 7,
      packagingUpdate: "New flavors released in 15.2 oz bottles.",
    },
  },
  ...
  {
    date: "2019",
    eventName: "Early Revenue",
    category: "Revenue",
    eventDescription:
      "Achieved modest sales through local and regional stores.",
    additionalInfo: {
      salesChannel: "Direct-to-consumer and small retailers",
    },
  },
  {
    date: "2022",
    eventName: "Revenue Growth",
    category: "Revenue",
    eventDescription:
      "Reported $60 million in annual revenue, up significantly from 2021.",
    additionalInfo: {
      keyDrivers: ["Expanded retail presence", "Celebrity endorsements"],
    },
  },
  {
    date: "2023",
    eventName: "Projected Revenue Milestone",
    category: "Revenue",
    eventDescription:
      "Set target to exceed $100 million in revenue by end of 2023.",
    additionalInfo: {
      growthFactors: [
        "Increased product offerings",
        "Expanded sampling campaigns",
      ],
    },
  },
  ...
  {
    date: "2020",
    eventName: "Partnership with Publix, Ralphs, and Stew Leonard's",
    category: "Retail & Distribution",
    eventDescription:
      "Secured distribution agreements with major regional chains, expanding presence.",
    additionalInfo: {
      DSDAgreements: [
        "Classic Beverage in California",
        "Big Geyser in New York",
      ],
      onlineSales: "Expanded to Amazon.",
    },
  },
  {
    date: "2021",
    eventName: "Entered Whole Foods, Target, and Sprouts",
    category: "Retail & Distribution",
    eventDescription:
      "Expanded distribution to major national retailers for greater accessibility.",
    additionalInfo: {
      retailerList: ["Whole Foods", "Target", "Sprouts Farmers Market"],
    },
  },
  {
    date: "2023",
    eventName: "Available in Costco and Convenience Stores",
    category: "Retail & Distribution",
    eventDescription:
      "Introduced multipacks in Costco and planned for distribution to convenience stores.",
    additionalInfo: {
      goal: "Broaden consumer reach and capture frequent, on-the-go buyers.",
    },
  },
];

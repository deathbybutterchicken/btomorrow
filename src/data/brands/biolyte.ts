...
export const timelineData = [
  {
    date: "2016",
    eventName: "Seed Funding of $1 million",
    category: "Funding",
    eventDescription:
      "Biolyte raised $1 million in seed funding from family to start operations and set up a pilot plant.",
    additionalInfo: {
      dealInfo: {
        dealTypes: "Seed Round",
        dealDate: "15-Jul-2016",
        dealStatus: "Completed",
        financingSource: "Family",
        stockSplit: "1:1",
      },
      companyInfo: {
        financingStatus: "Privately Held (no backing)",
        businessStatus: "Generating Revenue",
        ceoLeadMGT: "Dr. Luther 'Trey' Rollins",
        site: "Marietta, GA",
      },
      totalCapital: {
        dealAmount: "$1.00M",
        preMoneyValuation: "$157K",
        postValuation: "$1.16M",
        totalInvestedCapital: "$1.00M",
        raisedToDate: "$1.00M",
      },
      equity: {
        vcRound: "1st Round",
        percentAcquired: "100%",
        investorOwnership: "100%",
        totalInvestedEquity: "$1.00M",
      },
      dealSynopsis:
        "The company raised $1 million in seed funding from family investments to launch its flagship hydration drink.",
      investors: [
        {
          name: "Family",
          status: "New Investor",
  ...
  },
  {
    ...
    category: "Funding",
    eventDescription:
      "Raised Series A funding to support scaling operations and product expansion.",
    additionalInfo: {
      dealInfo: {
        dealTypes: "Series A",
        dealDate: "09-Jan-2021",
        dealStatus: "Completed",
      ...
      companyInfo: {
        ...
        businessStatus: "Generating Revenue",
        ceoLeadMGT: "Jesslyn Rollins",
        site: "Marietta, GA",
      },
      totalCapital: {
        dealAmount: "Undisclosed",
        preMoneyValuation: "Undisclosed",
        postValuation: "$25M (estimated revenue)",
        totalInvestedCapital: "Undisclosed",
        raisedToDate: "Undisclosed",
      },
      equity: {
        vcRound: "2nd Round",
        percentAcquired: "N/A",
        investorOwnership: "N/A",
        totalInvestedEquity: "Undisclosed",
      },
      dealSynopsis:
        "Biolyte secured Series A funding from private investors to support scaling and introduced new flavors Berry, Tropical, and Melon.",
      investors: [
        {
  ...
  },
  {
    ...
    category: "Funding",
    eventDescription:
      "Biolyte secured additional funding estimated at $250 million to fuel nationwide retail expansion and product line diversification.",
    additionalInfo: {
      dealInfo: {
        dealTypes: "Series B",
        dealDate: "12-Apr-2023",
        dealStatus: "Completed",
      ...
      totalCapital: {
        dealAmount: "$250M",
        preMoneyValuation: "$230M",
        postValuation: "$480M",
        totalInvestedCapital: "$250M",
        raisedToDate: "$250M",
      },
      equity: {
        vcRound: "3rd Round",
        percentAcquired: "52.08%",
        investorOwnership: "52.08%",
        totalInvestedEquity: "$250M",
      },
      dealSynopsis:
        "Biolyte raised $250 million in Series B funding to accelerate growth, expand nationwide, and introduce portable powder packs for hydration.",
      investors: [
        {
          name: "Private Equity",
          status: "New Investor",
  ...
  {
    date: "2016",
    eventName: "Founding of Biolyte",
    category: "Branding & Marketing",
    eventDescription:
      "Dr. Luther 'Trey' Rollins founded Biolyte as a response to his wife’s health challenges during cancer treatment.",
  },
  {
    date: "2019",
    eventName: "Jesslyn Rollins becomes CEO",
    category: "Branding & Marketing",
    eventDescription:
      "Jesslyn Rollins took on the role of CEO, contributing significantly to the growth and success of Biolyte through hands-on involvement in sales, marketing, and operations.",
  },
  {
    date: "2020",
    eventName: "Community and Awareness Campaigns",
    category: "Branding & Marketing",
    eventDescription:
      "Biolyte launched campaigns supporting healthcare workers and breast cancer patients, with proceeds benefiting the American Cancer Society.",
  },
  {
    date: "2022",
    eventName: "National Retail Expansion",
    category: "Retail & Distribution",
    eventDescription:
      "Biolyte expanded nationally, entering major retail chains like Target and Kroger, and increasing its retail presence in over 20,000 locations.",
  },
  {
    date: "2023",
    eventName: "Launch of New Products and Merch",
    category: "Product",
    eventDescription:
      "Introduced new flavors and portable powder hydration packs, diversifying the product line. Merch also launched and sold out multiple times.",
  },
  {
    date: "2024",
    eventName: "Biolyte Brand Refresh",
    category: "Branding & Marketing",
    eventDescription:
      "Partnered with Brown Bag for a brand refresh, expanding its product lineup and securing new retail partnerships. Sales reached record highs post-refresh.",
  },
];

export const HEADINGS = {
  line1: "MEDICAL-GRADE HYDRATION",
  line2: "IN A BOTTLE",
  mainHeading: "BIO.LYTE",
  imageAlt: "Biolyte Hydration Products",
};
